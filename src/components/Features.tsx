      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="relative p-10 bg-gradient-to-br from-black to-purple-950/20 border border-violet-500/30 rounded-2xl overflow-hidden group hover:border-violet-500/60 transition-all"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-violet-600/20 to-purple-700/20 blur-2xl group-hover:scale-150 transition-transform" />
              
              <div className="relative z-10">
                <div className="w-16 h-16 mb-6 bg-gradient-to-br from-violet-600 to-purple-700 rounded-2xl flex items-center justify-center">
