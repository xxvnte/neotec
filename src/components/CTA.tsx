...
export function CTA() {
  return (
    <section id="contacto" className="py-32 px-6 bg-gradient-to-b from-black to-purple-950/20">
      <div className="max-w-5xl mx-auto">
        <div className="relative p-12 md:p-16 bg-gradient-to-br from-purple-950/50 to-black border-2 border-violet-500/30 rounded-3xl overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            <h2 className="text-5xl md:text-6xl mb-6 bg-gradient-to-r from-violet-400 to-purple-500 bg-clip-text text-transparent">
              ¿Listo para Empezar?
            </h2>
            <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
              Conversemos sobre tu proyecto y llevemos tu idea al siguiente nivel con soluciones de software innovadoras
            </p>
